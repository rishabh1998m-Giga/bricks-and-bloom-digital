...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-[90] flex h-12 w-12 items-center justify-center rounded-full bg-transparent transition-all duration-300 animate-whatsapp-pulse hover:scale-110 md:bottom-8 md:right-8 md:h-14 md:w-14"
    >
      <svg
        viewBox="0 0 24 24"
        aria-hidden
        className="h-7 w-7 fill-[#25D366] drop-shadow-[0_4px_10px_rgba(37,211,102,0.45)] transition-transform duration-300 group-hover:scale-110 md:h-8 md:w-8"
      >
