...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-[90] flex items-center gap-3 rounded-full border border-border bg-card/85 px-4 py-3 shadow-[0_10px_30px_rgba(0,0,0,0.45)] backdrop-blur-md transition-colors duration-500 hover:border-accent md:bottom-8 md:right-8"
    >
      <svg
        viewBox="0 0 24 24"
        aria-hidden
        className="h-5 w-5 fill-moss transition-colors duration-500 group-hover:fill-accent md:h-6 md:w-6"
      >
      ...
      <span className="meta hidden text-foreground sm:inline">WhatsApp</span>
    </a>
  );
}
